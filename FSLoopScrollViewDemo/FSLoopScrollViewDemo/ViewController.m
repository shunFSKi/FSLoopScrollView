...
- (void)viewDidLoad {
    ...
    {
        FSLoopScrollView *loopView = [[FSLoopScrollView alloc]initWithFrame:CGRectMake(10, 20, CGRectGetWidth(self.view.bounds)-20, 200)];
    ...
    {
        FSLoopScrollView *loopView = [[FSLoopScrollView alloc]initWithFrame:CGRectMake(10, 300, CGRectGetWidth(self.view.bounds)-20, 200)];
